import { errorMessage, rebuildIndex } from '@dayjot/core'
 ...
 * projection from the markdown files and refresh the query caches. Shared by
 * the `index.rebuild` palette command and
